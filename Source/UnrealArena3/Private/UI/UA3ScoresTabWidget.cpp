...
#include "UI/UA3ScoresTabWidget.h"
...
void UUA3ScoresTabWidget::NativeOnInitialized()
{
    ...
    if (GetWorld())
    {
        ...
        if (GameMode)
        {
            GameMode->OnMatchStateChanged.AddUObject(this, &UUA3ScoresTabWidget::OnMatchStateChanged);
        }
    }
    //  UpdateScoresTabStat();
}

void UUA3ScoresTabWidget::OnMatchStateChanged(EUA3MatchState State)
{
...
void UUA3ScoresTabWidget::Show()
{
    UpdateScoresTabStat();
}

void UUA3ScoresTabWidget::UpdateScoresTabStat()
{
